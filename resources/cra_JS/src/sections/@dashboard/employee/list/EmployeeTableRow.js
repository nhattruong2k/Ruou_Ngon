...
export default function EmployeeTableRow({ row, selected, onSelectRow, onDeleteRow, onEditRow, onViewRow }) {
      ...
      <TableRow hover selected={selected}>
        ...
        <TableCell>
          ...
          <Label
            variant="soft"
            color={
              (row?.active_flag === 0 && 'warning') || 'success'
            }
            sx={{ textTransform: 'capitalize' }}
          >
            {row?.active_flag === 0 ? 'Ngừng hoạt động' : 'Hoạt động'}
          </Label>
        </TableCell>
