...
OrganizationRsbToolbar.propTypes = {
  onCloseDetails: PropTypes.func,
};

export default function OrganizationRsbToolbar({ onCloseDetails, onSave, title, isEdit, loadingBtnSave }) {
    ...
    <>
      <Stack p={2.5} direction="row" alignItems="center">
        ...
        <Stack direction="row" spacing={1} justifyContent="flex-end" flexGrow={1}>
          {(isDesktop || isMobile) && (
            <>
              <Tooltip title={!isEdit ? 'Lưu' : 'Cập nhật'}>
                <Button
                  color="success"
                  variant="contained"
                  size="small"
