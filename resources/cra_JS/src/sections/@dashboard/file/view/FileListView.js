...
const TABLE_HEAD = [
  ...
  { id: 'type', label: 'Loại', align: 'center', width: 120 },
  { id: 'created_at', label: 'Ngày tạo', align: 'center', width: 160 },
  { id: 'created_by', label: 'Người tạo', align: 'center', width: 200 },
  { id: '' },
];
...
export default function FileListView({ table, tableData, isNotFound, onDeleteRow, dataFiltered, onOpenConfirm, setViewFolder, refetchData, dataPaging }) {
  const {
    dense,
    page,
    order,
