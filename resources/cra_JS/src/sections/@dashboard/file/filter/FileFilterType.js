...
export default function FileFilterType({ optionsType, filterType, onFilterType, onReset, onSaveFilter }) {
  ...
  const renderLabel = filterType.length ? filterType.slice(0, 2).join(',') : 'Tất cả';
